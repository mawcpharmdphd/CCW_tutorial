...
model <- glm(
  long_cens_nostart ~ intv_age + as.numeric(sex == 1)  + renal,
  data = other_days,
...
save(wted_trt_0_30, file = "Stored_data/wted_trt_0_30.Rdata")
save(zeros_0_30, file = "Stored_data/zeros_0_30.Rdata")

summary(wted_trt_0_30$Cumulative_IPCW)
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 1.000   1.000   1.000   1.667   1.000  31.308 
